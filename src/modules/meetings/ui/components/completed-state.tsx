  ...
  return (
    <div className="flex flex-col gap-y-4">
      <Tabs defaultValue="summary">
        <div className="bg-white rounded-lg border-lg border px-3">
          <ScrollArea>
            ...
            <div className="px-4 py-5 gap-y-5 flex flex-col col-span-5">
              ...
              <div className="">
                <Markdown
                  components={{
                    h1: ({ node, ...props }) => (
                      <h1 className="text-3xl font-semibold mb-4" {...props} />
                    ),
                    h2: ({ node, ...props }) => (
                      <h2
                    ...
                    pre: ({ node, ...props }) => (
                      <pre
                        className="bg-muted p-4 rounded overflow-x-auto text-sm mb-4"
                        {...props}
                      />
                    ),
